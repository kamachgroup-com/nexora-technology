...
Computers, PC hardware, laptops, displays & peripherals

Audience

Gamers, creators, professionals, students & everyday users

Visual Language

Dark, precise, modern, technical
...
Keep the repository Public if using the intended free GitHub Pages setup.

Upload the project files to the repository root.

Make sure index.html is located at the root.
